...
func TestIngesterTransfer(t *testing.T) {
	...
	ing1, err := New(cfg1, defaultClientTestConfig(), limits, nil, nil, chunk.NewDummyTombstonesLoader())
	require.NoError(t, err)
	...
	ing2, err := New(cfg2, defaultClientTestConfig(), limits, nil, nil, chunk.NewDummyTombstonesLoader())
	require.NoError(t, err)
...
func TestIngesterBadTransfer(t *testing.T) {
	...
	ing, err := New(cfg, defaultClientTestConfig(), limits, nil, nil, chunk.NewDummyTombstonesLoader())
	require.NoError(t, err)
