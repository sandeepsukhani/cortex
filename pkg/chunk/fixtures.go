...
func (dummyTombstonesAnalyzer) GetDeletedIntervals(labels labels.Labels, from, to model.Time) Intervals {
	return nil
}
...
// NewDummyTombstonesLoader creates a new MockTombstonesLoader
func NewDummyTombstonesLoader() DummyTombstonesLoader {
