...
func NewTombstonesLoader(deleteStore *DeleteStore) chunk.TombstonesLoader {
	tl := tombstonesLoader{
		tombstones:  map[string]*TombstonesSet{},
		deleteStore: deleteStore,
	}
...
func (tl *tombstonesLoader) GetPendingTombstones(userID string) (chunk.TombstonesAnalyzer, error) {
